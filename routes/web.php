...
// Route::group(['middleware' => 'auth'], function () {
    Route::get('/farmerform', [FarmerController::class, 'farmerForm'])->name('farmerform');
    Route::post('/farmerform/submit', [FarmerController::class, 'submitFarmerForm'])->name('farmerform.sub');
...
// Route::get('/products/filters', [FarmerController::class, 'filterCategory'])->name('products.filter');
